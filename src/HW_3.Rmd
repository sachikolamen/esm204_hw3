...
overall_welfare_high_cons <- CS_high - high_welfare_tax
```
...
demand_tax_low <- demand(p_new_a, demand_low)

env_cost_tax <- MEC*q_new_a

welfare_tax_low <- (0.5*(0.2337-0.0197-0.0932)*demand_tax_low)-(demand_tax_low*0.0197)-env_cost_tax
