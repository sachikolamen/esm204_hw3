...
# Need to find slope of supply curve to find supply curve (we know y-intercept is 0)
# Slope = price/quantity (we know supply curve intersects aggregate demand curve @ 10 cents)
supply_slope <- 10/Q0

P_env <- MEC*Q0

env_cost_sq <- P_env*Q0*0.5
```
...
4. Derive the optimal electricity tax (in cents/kWh) using the interim SCC. Noting that recent research has show th epoor face a disproportionate share of the impacts from climate change, assume that the climate externailty is borne entirely by the "low" income group. What would be the effects of this tax on:
